"""
This is an implementation of the A3C RL agent as described in SC2LE paper by DeepMind.
It was developed by Lim Swee Kiat (github user greentfrapp), 
who based it on Arthur Juliani's implementation of A3C for the game Doom.
The following is greentfrapp's docstring:
